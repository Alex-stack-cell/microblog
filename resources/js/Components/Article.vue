...
<template>
    <div class="p-6 flex space-x-2">
        ...
        <div class="flex-1">
            <div class="flex justify-between items-center">
                ...
                <Dropdown v-if="article.user.id === $page.props.auth.user.id">
                    ...
                    <template #content>
                        ...
                        <DropdownLink as="button" :href="route('article.destroy', article.id)" method="delete">
                            Delete
                        </DropdownLink>
                    </template>
                </Dropdown>
            ...
            <p v-else class="mt-4 text-lg text-gray-900">{{ article.message }}</p>
        </div>
    </div>
